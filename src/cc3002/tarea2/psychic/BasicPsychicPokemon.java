...
/**
 * Class that represents a basic psychic Pokemon.
 *
...
public class BasicPsychicPokemon extends AbstractPsychicPokemon implements IBasicPokemon {
    ...
    /**
     * Creates a new basic psychic Pokemon.
     *
     ...
     */
    public BasicPsychicPokemon(String pokedexNumber, int hp, int maxHP, IAbility selectedAbility, List<IAbility> abilityList, EnergyCounter energies) {
