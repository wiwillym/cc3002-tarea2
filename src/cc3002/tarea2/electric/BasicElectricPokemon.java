...
/**
 * Class that represents an electric basic Pokemon.
 *
...
public class BasicElectricPokemon extends AbstractElectricPokemon implements IBasicPokemon {
    ...
    /**
     * Creates a new basic electric Pokemon.
     *
     ...
     */
    public BasicElectricPokemon(String pokedexNumber, int hp, int maxHP, IAbility selectedAbility, List<IAbility> abilityList, EnergyCounter energies){
