...
/**
 * Class that represents a basic fire Pokemon.
 *
...
public class BasicFirePokemon extends AbstractFirePokemon implements IBasicPokemon {
    ...
    /**
     * Creates a new basic fire Pokemon.
     *
     ...
     */
    public BasicFirePokemon(String pokedexNumber, int hp, int maxHP, IAbility selectedAbility, List<IAbility> abilityList, EnergyCounter energies){
