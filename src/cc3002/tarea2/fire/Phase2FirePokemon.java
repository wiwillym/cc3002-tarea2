 ...
 */
public class Phase2FirePokemon extends AbstractFirePokemon implements IPhase2Pokemon {

    /**
     * Creates a new phase 2 fire Pokemon.
     *
     ...
     */
    public Phase2FirePokemon(String pokedexNumber, int hp, int maxHP, IAbility selectedAbility, List<IAbility> abilityList, EnergyCounter energies) {
